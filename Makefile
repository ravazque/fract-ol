...
OBJ_DIR = objects
SRC_DIR = src
LIBFT_DIR = $(SRC_DIR)/libft_fractol
...
SRC_PATHS = $(addprefix $(SRC_DIR)/, fractol.c init.c render.c math_utils.c events.c string_utils.c)
LIBFT_PATHS = $(addprefix $(LIBFT_SRC_DIR)/, \
	ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c \
	ft_memset.c ft_bzero.c ft_memcpy.c ft_memmove.c ft_strlcpy.c ft_strlcat.c ft_toupper.c \
	ft_tolower.c ft_strchr.c ft_strrchr.c ft_strncmp.c ft_memchr.c ft_memcmp.c ft_strnstr.c \
	ft_atoi.c ft_calloc.c ft_strdup.c ft_substr.c ft_strjoin.c ft_strtrim.c ft_split.c \
...
ALL_SRCS = $(SRC_PATHS) $(LIBFT_PATHS)
...
$(OBJ_DIR)/%.o: $(LIBFT_SRC_DIR)/%.c | $(OBJ_DIR)
	$(CC) $(CFLAGS) -c $< -o $@
